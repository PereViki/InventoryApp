...
public final class ProductContract {
    ...
    public static final class ProductEntry implements BaseColumns {
        ...
        /**
         * Returns whether or not the given category is {@link #CATEGORY_UNKNOWN}, {@link #CATEGORY_1},
         * or {@link #CATEGORY_2}.
         */
        public static boolean isValidCategory(int category) {
            if (category == CATEGORY_UNKNOWN || category == CATEGORY_1 || category == CATEGORY_2) {
                return true;
            }
            return false;
        }
